    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Гарантийная политика сервисного центра ПРАЙМ
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 text-foreground">
          ...
          <p>
            Сервисный центр ПРАЙМ предоставляет гарантию на все выполненные работы и установленные запчасти. 
          ...
          <p>
            От 3 месяцев до 24 месяцев, в зависимости от зап. частей, сложности ремонта и оборудования. 
          ...
          <p>
            ПРАЙМ оставляет за собой право отказать в гарантийном обслуживании при нарушении пользователем правил эксплуатации устройства или условий гарантии.
