    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogTitle className="text-center text-xl font-bold">Заявка отправлена!</DialogTitle>
          <DialogDescription className="text-center text-base">Спасибо! Заявка принята.</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="border-t pt-4">
            <h3 className="text-center font-semibold mb-3">Оставайтесь в курсе наших новостей!</h3>
            <p className="text-sm text-muted-foreground text-center mb-3">
              Подпишитесь на наши группы и получайте эксклюзивные предложения
            </p>

            <p className="text-xs text-muted-foreground leading-snug mb-3">
              Telegram, ВКонтакте и MAX — сторонние сервисы; при переходе действуют их правила и политики данных.
            </p>

            <div className="flex items-start gap-2 rounded-md border border-border p-3 mb-3">
              <Checkbox
                id="success-third-party-ack"
                checked={thirdPartyAck}
                onCheckedChange={(v) => setThirdPartyAck(v === true)}
                className="mt-0.5"
              />
              <Label htmlFor="success-third-party-ack" className="text-xs font-normal leading-snug cursor-pointer">
                Подтверждаю переход на сторонние площадки и применение их правил.
              </Label>
            </div>

            <div className="flex items-start gap-2 rounded-md border border-dashed border-border p-3 mb-3">
              <Checkbox
                id="success-marketing-optin"
