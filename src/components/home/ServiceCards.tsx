...
const ServiceCard: React.FC<ServiceCardProps> = ({ icon, title, description, delay }) => {
  return (
    <div 
      className="bg-background rounded-xl p-6 shadow-sm border border-border transition-all duration-300 hover:shadow-md hover:translate-y-[-5px] group"
      style={{ animationDelay: `${delay}s` }}
    >
      <div className="w-12 h-12 flex items-center justify-center rounded-lg bg-primary/10 text-primary mb-4 transition-colors group-hover:bg-primary group-hover:text-white">
        {icon}
      </div>
    ...
    <section className="py-20">
      <div className="container px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="heading-lg mb-4">Ремонт любой сложности</h2>
          <p className="body-lg text-muted-foreground max-w-3xl mx-auto">
            Мы предлагаем полный спектр услуг по ремонту цифровой и бытовой техники любых брендов и моделей с гарантией качества
          </p>
        </div>
