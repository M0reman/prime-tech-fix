            ...
            <div className="flex space-x-4 pt-2">
              <a href="https://vk.com/serviceprime" className="text-muted-foreground hover:text-primary transition-colors" itemProp="sameAs">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0,0,256,256">
                  <g fill="#717479" fillRule="nonzero" stroke="currentColor" strokeWidth="1.2" strokeLinecap="butt" strokeLinejoin="miter" strokeMiterlimit="10" strokeDasharray="" strokeDashoffset="0" fontFamily="none" fontWeight="none" fontSize="none" textAnchor="none">
