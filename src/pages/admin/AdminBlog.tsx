...
const AdminBlog: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Управление блогом | Админ-панель Прайм</title>
        <meta name="description" content="Административная панель для управления блогом сервисного центра Прайм. Создание, редактирование и удаление статей о ремонте техники." />
        <meta name="robots" content="noindex, nofollow" />
        <meta name="author" content="Прайм Admin" />
        {/* Open Graph */}
        <meta property="og:title" content="Управление блогом | Админ-панель Прайм" />
        <meta property="og:description" content="Административная панель для управления блогом сервисного центра Прайм." />
