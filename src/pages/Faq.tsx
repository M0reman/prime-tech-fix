      ...
      items: [
        {
          ...
          answer: (
            <p>
              Базовая диагностика занимает от 15 минут до 1 часа в зависимости от устройства и сложности неисправности. 
        ...
        },
        {
          ...
          answer: (
            <div>
              <p className="mb-2">
                Да, мы предоставляем гарантию на все виды ремонтных работ:
              </p>
              <ul className="list-disc pl-5 space-y-1">
                <li>До 12 месяцев на замену комплектующих</li>
                <li>До 6 месяцев на ремонт материнских плат и системных плат</li>
                <li>До 3 месяцев на программное обеспечение</li>
              </ul>
              <p className="mt-2">
                Гарантийный талон выдается после завершения ремонта.
              </p>
            </div>
          )
        },
        {
          question: "Можно ли отремонтировать устройство в день обращения?",
          answer: (
            <p>
              Да, многие виды ремонта мы выполняем в течение 1-2 часов при наличии необходимых запчастей. 
              Это касается замены экранов на смартфонах, замены батарей, чистки ноутбуков и многих других услуг. 
              Точное время ремонта мы сможем назвать после диагностики.
            </p>
          )
        },
        {
          ...
          answer: (
            <p>
              Да, мы работаем как с физическими, так и с юридическими лицами. Для организаций предлагаем специальные 
              условия обслуживания, включая заключение договоров на постоянное обслуживание, выезд мастера в офис и 
              возможность безналичной оплаты. Полный пакет документов предоставляется.
            </p>
          )
        }
      ]
